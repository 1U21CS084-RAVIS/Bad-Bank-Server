...
export default function Deposit() {
    ...
    if (e === "Choice the Acc") {
        ...
        if (selectedIndex !== -1) {
            ...
            setHide(
                <>
                    <h2 style={{color:"red",marginLeft:"20%"}}>Balance: {product[selectedIndex].amount}</h2>
    ...
    return (
        <>
            <div id='Trans' style={{backgroundColor:"lightgray",marginLeft:"30%",width:"40%",marginTop:"10%" ,borderRadius:"5%"}}>
                <h1 style={{color:"red",marginLeft:"20%"}}>Cashback</h1>
